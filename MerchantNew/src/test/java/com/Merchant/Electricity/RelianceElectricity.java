package com.Merchant.Electricity;
...
public class RelianceElectricity extends AppBase{
	...
	public void ElectricityRecharge(Hashtable<String,String> data){
		...
		try {
			...
			Thread.sleep(1000);
			driver.findElement(By.xpath(prop.getProperty("mobilenumb"))).sendKeys(data.get("Mobile"));test.log(LogStatus.INFO, "Entering the Mobile Number");
			driver.findElement(By.xpath(prop.getProperty("elecconsumer"))).sendKeys(data.get("CA Number"));test.log(LogStatus.INFO, "Entering the CA Number");
			driver.findElement(By.xpath(prop.getProperty("eleccycle"))).sendKeys(data.get("Cycle No"));test.log(LogStatus.INFO, "Entering the Bill No");
			driver.hideKeyboard();
			driver.findElement(By.xpath(prop.getProperty("fetchBill"))).click();test.log(LogStatus.INFO, "Clicking on Fetch bill Button");
			Thread.sleep(8000);
			Util.takeScreenShot("Bill Fetched");
			driver.findElement(By.xpath(prop.getProperty("elecpaybill"))).click();test.log(LogStatus.INFO, "Clicking on Fetch bill Button");
			Util.takeScreenShot("Bill by BBPS");test.log(LogStatus.PASS, "Successfully fetched the bill");
			driver.findElement(By.xpath("//android.widget.TextView[@text='NO']")).click();
			driver.findElement(By.className("android.widget.ImageButton")).click();
			driver.findElement(By.className("android.widget.ImageButton")).click();
			msg ="Successfully fetched the bill"; fail=false;
		} catch (InterruptedException e){
			// TODO Auto-generated catch block
			test.log(LogStatus.ERROR, "Issue while doing a Electricity Recharge");
			msg="Issue while doing a Electricity Recharge";
			e.printStackTrace();
		}
	}
