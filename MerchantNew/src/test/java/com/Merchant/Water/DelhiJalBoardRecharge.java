...
public class DelhiJalBoardRecharge extends AppBase{
	...
	public void WaterRecharge(Hashtable<String,String> data){
		...
		try {
			...
			// TODO Auto-generated catch block
			test.log(LogStatus.ERROR, "Issue while doing a Water Recharge");
			msg="Issue while doing a Water Recharge";
			e.printStackTrace();
		}
	}
