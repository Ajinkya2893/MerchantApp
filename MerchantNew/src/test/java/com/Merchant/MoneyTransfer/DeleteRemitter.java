...
public class DeleteRemitter extends AppBase {
	...
	public void RemoveFirstRemitter(Hashtable<String,String> data){
		count++;
		try {
			...
			driver.findElement(By.xpath(prop.getProperty("manageBtn"))).click();test.log(LogStatus.INFO, "Clicking on manage button");
			driver.findElement(By.xpath(prop.getProperty("searchsender"))).sendKeys(data.get("Search"));test.log(LogStatus.INFO, "Entering the sender number");
			Thread.sleep(8000);
			driver.hideKeyboard();
			driver.findElement(By.xpath(prop.getProperty("deletebtn"))).click();test.log(LogStatus.INFO, "Clicking on delete button");
			Util.takeScreenShot("delete pop up");
			Thread.sleep(3000);
			driver.findElement(By.xpath(prop.getProperty("yesbtn"))).click();test.log(LogStatus.INFO, "Clicking on Yes button");
			Thread.sleep(5000);Util.takeScreenShot("Successfully deleted Remitter");
