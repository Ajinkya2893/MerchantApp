...
public class PrepaidRecharge extends AppBase
{
	...
	public void mobileRecharge(Hashtable<String,String> data){
		...
		try {
			...
			driver.findElement(By.xpath(prop.getProperty("selectProduct"))).click();test.log(LogStatus.INFO, "Selecting the Product");//Idea change any service provider needed
			Thread.sleep(1000);
			driver.findElement(By.id(prop.getProperty("mobileNumber"))).sendKeys(data.get("Mobile"));test.log(LogStatus.INFO, "Entering the MobileNumber");
